    ...
    before all => sub {
        ...
        $lwpMock->addMock('request')->returns(
            HTTP::Response->new(
                ...
                "ok",
                undef,
                '{"spec":{}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/pods/myPod"}, "status":{}, "kind":"Pod", "apiVersion":"v1beta3"}'
            )
        );
    ...
    before all => sub {
        ...
        $lwpMock->addMock('request')->returns(
            HTTP::Response->new(
                ...
                "ok",
                undef,
'{"spec":{"selector":{"name":"myReplicates"}}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/replicationcontrollers/myRc"}, "status":{}, "kind":"ReplicationController", "apiVersion":"v1beta3"}'
            )
        );
        $sut = $ns->get_rc('myRc');
    };
    ...
    before all => sub {
        ...
        $lwpMock->addMock('request')->returns(
            HTTP::Response->new(
                ...
                "ok",
                undef,
'{"spec":{"selector":{"name":"myReplicates"}}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/replicasets/myRs"}, "status":{}, "kind":"ReplicaSet", "apiVersion":"v1beta3"}'
            )
        );
        $sut = $ns->get_rs('myRs');
    };
    ...
    before all => sub {
        ...
        $lwpMock->addMock('request')->returns(
            HTTP::Response->new(
                ...
                "ok",
                undef,
'{"spec":{"selector":{"name":"myReplicates"}}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/deployments/meDeploy"}, "status":{}, "kind":"Deployment", "apiVersion":"v1beta3"}'
            )
        );
...
describe "Net::Kubernetes - Pod Objects " => sub {
    before all => sub {
        ...
        $lwpMock->resetMocks;
        $lwpMock->addMock('request')->with(code(sub { my ($mo, $re) = @{$_[0]}; return $re->uri =~ m/myPod$/ ? 1 : 0; }))->returns(
            HTTP::Response->new(
                200,
                "ok",
                undef,
'{"spec":{"selector":{"name":"myReplicates"}, "containers":[{}]}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/pods/myPod"}, "status":{}, "kind":"Pod", "apiVersion":"v1beta3"}'
            )
        );
    ...
    describe "container logs" => sub {
        ...
        it "fetches logs from kubernetes on demand" => sub {
            $lwpMock->addMock('request')->with(code(sub { my ($mo, $re) = @{$_[0]}; return $re->uri =~ m{myPod/log$} ? 1 : 0; }))
                ->returns(HTTP::Response->new(200, "ok", undef, 'LOGS, LOGS, LOGS'));
            $sut->logs();
            my ($call) = $lwpMock->verify('request')->once->getCalls->[0];
            isa_ok($call->[1], 'HTTP::Request');
            is($call->[1]->method, 'GET');
        ...
        it "passes container name to kubernetes as a parameter if recieved" => sub {
            $lwpMock->addMock('request')->with(code(sub { my ($mo, $re) = @{$_[0]}; return $re->uri =~ m{myPod/log\?container=foo$} ? 1 : 0; }))
                ->returns(HTTP::Response->new(200, "ok", undef, 'LOGS, LOGS, LOGS'));
...
describe "Net::Kubernetes - Node Objects " => sub {
    ...
    before all => sub {
        ...
        $lwpMock->resetMocks;
        $lwpMock->addMock('request')->with(code(sub { my ($mo, $re) = @{$_[0]}; return $re->uri =~ m/myNode$/ ? 1 : 0; }))->returns(
            HTTP::Response->new(
                200,
                "ok",
                undef,
'{"spec":{"externalId":"172.18.8.102"}, "metadata":{"selfLink":"/api/v1beta3/nodes/myNode", "name":"myNode"}, "status":{}, "kind":"Node", "apiVersion":"v1"}'
            )
        );
    ...
    describe "get_pods" => sub {
        ...
        it "gets a list of pods from kubernetes on demand" => sub {
            $lwpMock->addMock('request')->with(code(sub { my ($mo, $re) = @{$_[0]}; return $re->uri =~ m{pods\?fieldSelector} ? 1 : 0; }))->returns(
                HTTP::Response->new(
                    200, "ok", undef,
                    '{"status":"ok", "apiVersion":"v1beta3", "items":[{"spec":{}, "metadata":{"selfLink":"/path/to/me"}, "status":{}}]}'
                )
            );
            $sut->get_pods();
            my ($call) = $lwpMock->verify('request')->once->getCalls->[0];
    ...
    before all => sub {
        ...
        $lwpMock->addMock('request')->returns(
            HTTP::Response->new(
                ...
                "ok",
                undef,
'{"spec":{"selector":{"name":"myReplicates"}}, "status":{}, "metadata":{"selfLink":"/api/v1beta3/namespaces/default/replicationcontrollers/myRc"}, "kind":"Service", "apiVersion":"v1beta3"}'
            )
        );
